  ...
  return (
    <section id={title}>
      ...
      <Swiper
        ...
        className={`!px-4 !pb-[2rem] !pt-[2.5rem] max-w-7xl xl:max-w-none xl:!px-[8.35rem] !pr-[3rem] relative before:absolute before:inset-0 before:bg-gradient-to-r before:from-base-dark-gray before:max-w-[8.35rem] before:z-10 after:absolute after:top-0 after:right-0 after:!w-[8.35rem] after:!h-full after:bg-gradient-to-l after:from-base-dark-gray after:z-10 before:hidden after:hidden xl:before:block xl:after:block before:pointer-events-none after:pointer-events-none`}
      >
        ...
        <div className="z-20 absolute top-0 left-0 right-0 h-[28px] px-4 max-w-7xl xl:max-w-none xl:px-[8.35rem] flex justify-between items-end">
